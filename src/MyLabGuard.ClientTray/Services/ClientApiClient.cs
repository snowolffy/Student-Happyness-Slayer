...
using MyLabGuard.ClientTray.Models;

namespace MyLabGuard.ClientTray.Services;

/// <summary>
/// คุยกับ MyLabGuard.Client (Windows Service ตัวจริง) ผ่าน local API ที่ localhost:8788
...
public class ClientApiClient
{
    ...
    /// <summary>ดึงสถานะปัจจุบัน คืน null ถ้า Client Service ไม่ได้รันอยู่ (เช่นถูก restart)</summary>
